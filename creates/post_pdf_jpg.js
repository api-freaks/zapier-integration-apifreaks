const perform = async (z, bundle) => {
  const response = await z.request({
    url: "https://api.apifreaks.com/v1.0/pdf/jpg",
    method: "POST",
    params: { "file_id": bundle.inputData["file_id"], "destroy": bundle.inputData["destroy"], "output": bundle.inputData["output"], "quality": bundle.inputData["quality"], "pages": bundle.inputData["pages"], "resolution": bundle.inputData["resolution"], "image_smoothing": bundle.inputData["image_smoothing"], "profile": bundle.inputData["profile"], "webhook_url": bundle.inputData["webhook_url"], "webhook_failure_notification": bundle.inputData["webhook_failure_notification"] },
  });
  ...
  operation: {
    inputFields: [
      ...
      },
      {
        ...
        type: 'string',
        required: false,
        helpText: "Controls JPG compression quality. Higher values yield sharper images with larger file sizes.",
      },
      {
        key: "pages",
        label: "Pages",
